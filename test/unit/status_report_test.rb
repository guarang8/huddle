...
class StatusReportTest < ActiveSupport::TestCase
  test "saving the report saves the status date" do
  ...
  test "a report with blank yesterday and today fields is not valid" do
  ...
  test "by user name should sort as expected" do
  	...
  	assert_equal [ "one@one.com", "one@one.com", "two@two.com",
  		"two@two.com"], expected
  end
end
